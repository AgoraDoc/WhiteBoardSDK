...
public class MemberState extends WhiteObject {
     ...
     * 获取用户设置的线条颜色。
     *
     * @return 线条颜色，为 RGB 格式，例如，[0, 0, 255] 表示蓝色。//TODO WJ rgb 格式的写法好像应该是 (0,0,255)
     */
     ...
     * 设置线条粗细。
     *
     * @param strokeWidth 线条粗细。//TODO WJ 单位是啥？
     */
     ...
     * 设置字体大小。
     *
     * @param textSize 字体大小。Chrome 浏览器对于小于 12 的字体会自动调整为 12。//TODO WJ 单位是 pt 吗？
     */
