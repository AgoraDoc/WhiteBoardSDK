...
/**
 * The view state of the local user, as well as the user information of the host (if any) in the room. //TODO William Is there a difference between view "state" and view "mode"? Should this be "mode"?
 *
